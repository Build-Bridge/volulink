    ...
    <div className='w-full max-w-[430px] mx-auto py-10'>
        ...
        <div className='my-5'>
            ...
            <form autoComplete='off' className='my-5 space-y-5'>
                ...
                <div>
                    <AuthButton text='Sign up' bgColor='bg-black' textColor='text-white' />
                </div>
            </form>
            <div className='my-5 space-y-3'>
                <div>
                <AuthButton icon='/img/google.svg' text='Continue with Google' bgColor='bg-transparent' textColor='text-black' />
                </div>
                <div>
                <AuthButton icon='/img/apple.svg' text='Continue with Apple' bgColor='bg-transparent' textColor='text-black' />
                </div>
            </div>

            <div className='w-full flex items-center  justify-center'>
                <small className='text-[12px] leading-3 text-center'>Already have an account?  <Link className='text-blue-800' href={'/auth/login'}>Log in</Link></small>
            </div>
        </div>
    </div>
  )
